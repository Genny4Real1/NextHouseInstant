class AppDurations {
  ...
  static const Duration captureFeedback = Duration(milliseconds: 500); // Tempo anteprima scatto
  static const Duration processing = Duration(milliseconds: 500); // Tempo elaborazione finta
