...
void main() {
  ...
  testWidgets('CaptureScreen flashes and clears', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: CaptureScreen())));
  ...
  testWidgets('CaptureEndScreen renders blurred bg', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: CaptureEndScreen())));
  ...
  testWidgets('AskAnotherScreen renders dialog with Yes/No', (
    ...
    var yesTapped = 0;
    var noTapped = 0;
    await tester.pumpWidget(_wrap(AskAnotherScreen(
  ...
  testWidgets('ResultScreen renders gallery toolbar', (WidgetTester tester) async {
  ...
  testWidgets('ShareSelectionScreen renders Done pill', (WidgetTester tester) async {
    await tester.pumpWidget(_wrap(PhotoSelectionShareScreen(
      capturedImages: <String>[],
  ...
  testWidgets('ShareConfirmScreen renders AreYouSure card', (WidgetTester tester) async {
    await tester.pumpWidget(_wrap(ShareConfirmScreen(onYes: () {}, onNo: () {})));
    expect(find.textContaining('unselected images'), findsOneWidget);
    expect(find.text('Yes'), findsOneWidget);
    expect(find.text('No'), findsOneWidget);
  });

  testWidgets('ShareUploadingScreen renders spinner', (WidgetTester tester) async {
    await tester.pumpWidget(_wrap(ShareUploadingScreen(capturedImages: <String>[])));
  ...
  testWidgets('PhotoGalleryScreenShare2 renders QR card + tap-to-go-back', (
    ...
    await tester.pumpWidget(_wrap(PhotoGalleryScreenShare2(
  ...
  testWidgets('OnboardingOverlay auto-dismisses after 5s', (WidgetTester tester) async {
    var dismissed = 0;
    await tester.pumpWidget(_wrap(Scaffold(
      body: OnboardingOverlay(
        message: 'Test hint 2',
